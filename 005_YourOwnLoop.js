...
function loop(inputValue, testFunction, updateFunction, executionFunction) {
    for (let value = inputValue; testFunction(value); value = updateFunction(value)) {
        executionFunction(value);
    }
}
